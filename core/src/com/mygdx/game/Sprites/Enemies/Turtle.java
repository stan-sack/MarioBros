...
public class Turtle extends Enemy {
    ...
    public Turtle(PlayScreen screen, float x, float y) {
        ...
        shellAnimation = new Animation(.2f, frames);
        frames.clear();
    ...
    protected void defineEnemy() {
        ...
        //create goomba head here
        PolygonShape head = new PolygonShape();
        Vector2[] verticie = new Vector2[4];
        verticie[0] = new Vector2(-5, 8).scl(1/MarioBros.PPM );
        verticie[1] = new Vector2(5, 8).scl(1/MarioBros.PPM );
        verticie[2] = new Vector2(-3, 3).scl(1/MarioBros.PPM );
        verticie[3] = new Vector2(3, 3).scl(1/MarioBros.PPM );
        head.set(verticie);
